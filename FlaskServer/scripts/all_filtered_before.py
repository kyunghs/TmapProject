...
day_folder = "20240603"
base_directory = os.path.join("/Tmap_project_Data/sorted", day_folder)
...
if not csv_files:
    ...
    for file in csv_files:
        ...
        # 필요한 컬럼만 선택
        columns = [
            'PARKING_CODE', 'PARKING_NAME', 'ADDR', 'OPERATION_RULE_NM', 'CAPACITY', 
            'CUR_PARKING', 'CUR_PARKING_TIME', 'PAY_YN', 'RATES', 'ADD_RATES', 
            'DAY_MAXIMUM', 'LAT', 'LNG'
        ]
